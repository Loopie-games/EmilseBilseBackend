...
namespace moonbaboon.bingo.DataAccess.Test.Repositories
{
    public class UserRepositoryTest
    {
        ...
        public void TestInsert()
        {
            ...
            var ent = new User("81d7f01e-57c9-4151-b31b-86881192dbf0","Demetra","dpawlicki0", null, null, "nothing", "2000-12-12");
        ...
        public void TestReadById(string id,string username,string nickname,string? profilePic, string? bannerPic, string email, string birthDate)
        {
            //Arrange
            ...
            readerMock.Setup(reader => reader.GetString(6)).Returns(birthDate);
